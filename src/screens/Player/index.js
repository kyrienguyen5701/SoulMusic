...
const Player = () => {
  ...
  const forward = useCallback(() => {
    ...
    state.playedSongs[state.selectedSong],
    state.selectedSong,
    state.indexAtSource,
  ]);
      ...
      <TouchableOpacity
        ...
        <Disk
          uri={`https://i.ytimg.com/vi/${
            state.playedSongs[state.selectedSong].id
          }/hqdefault.jpg`}
        />
        <Text
          numberOfLines={2}
        ...
        <View
          ...
          <Pause pause={pause} paused={state.paused} height={24} width={24} />
          {state.paused ? (
            <Discard height={24} width={24} discard={discard} />
          ) : (
        ...
        <LinearGradient colors={['#0C08C4', '#030239', '#000000']}>
          <View
            ...
            <Text
              ...
              {state.playedSongs[state.selectedSong].channel}
            </Text>
            <View
              style={{
                width: '100%',
